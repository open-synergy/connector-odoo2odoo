...
class OdooProductPricelist(models.Model):
    ...
    _description = "Product Pricelist Binding"
...
class OdooProductPricelistExporter(OdooSyncExporter):
    _model_name = "odoo.product.pricelist"
    ...
    def match_external_record(self, binding):
        ...
        for lang_code in lang_codes:
            ...
            logger.debug(
                u"%s - Try to match the Pricelist '%s' (lang='%s')...",
            ...
            if external_id:
                ...
                logger.debug(
                    u"%s - Pricelist '%s' (ID=%s) matches with "
                    u"the external Pricelist '%s' (ID=%s)",
